  ...
  return (
    <div className="grid gap-6">
      <Accordion  type="single" collapsible>
        <AccordionItem value="item-1" className='glass rounded-md border bg-white p-4 shadow-sm'>
          <AccordionTrigger className="cursor-pointer">Add Rules</AccordionTrigger>
          <AccordionContent>
            <RulesAddition />
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2" className='glass rounded-md border bg-white p-4 shadow-sm'>
